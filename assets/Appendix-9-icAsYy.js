import{l as e}from"./index-XXKoCGBl.js";import{G as t}from"./GuidePage-C3sHEvLY.js";/* empty css                 */import"./SEOHead-CEx7Gdxf.js";import"./index-CZhRCO18.js";import"./index-CkoXqNiT.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.

| 용어 | 쉬운 설명 |
|------|-----------|
| **생성형 AI(Generative AI)** | 글·이미지·코드 등 새로운 결과물을 "만들어내는" 인공지능. 분류·예측 중심의 기존 AI와 달리 창작에 강합니다. |
| **LLM(거대 언어모델)** | 방대한 텍스트로 학습한 언어 AI. ChatGPT, Claude, 생성형 AI의 두뇌에 해당합니다. |
| **생성형 AI** | 명지대 구성원을 위한 교내 전용 AI 플랫폼. **생성형 AI** 기술을 기반으로 하며, 교내 데이터를 비교적 안전하게 다룰 수 있습니다. |
...
| **LLM** | Large Language Model — the "brain" behind ChatGPT, Claude, multi-LLM. |
| **Multi-LLM** | Major generative AI tools (ChatGPT, Claude, Gemini) used for hands-on practice. |
...
> 용어가 헷갈리면 생성형 AI에 "이 용어를 신입 직원도 알게 쉽게 설명해줘"라고 물어보세요.`,contentEn:`Terms for academic writing, research, and budgeting.
...
> Stuck on a term? Ask multi-LLM to "explain this so a new staff member understands."`}]},n={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- multi-LLM is campus-only and safer, but still minimize sensitive data.`}]},i={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.

### 공통 1단계 — 기초 다지기
1. 생성형 AI에 매일 1가지 업무를 맡겨보기(메일 다듬기, 요약 등)
...
**Stage 1 — Foundations**
1. Give multi-LLM one daily task (polish an email, summarize, etc.).
...
> 각 주제를 생성형 AI에게 "초보자용 30분 학습 계획으로 짜줘"라고 부탁해보세요.`,contentEn:`Topics to explore further (also usable as search terms).
...
> Ask multi-LLM to "make a 30-minute beginner study plan" for any topic.`},{title:"혼자서도 잘 하는 연습법",titleEn:"How to Practice Solo",content:`- **하루 1프롬프트**: 오늘 한 업무 하나를 AI로 다시 해보기
