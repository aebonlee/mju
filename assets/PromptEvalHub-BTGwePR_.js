import{C as r,l as e,L as i}from"./index-Cn6Iu7og.js";import{G as n}from"./GuidePage-Cwcw1qyb.js";import{P as a}from"./PromptEvalNav-COJwAcOG.js";/* empty css                 */import"./SEOHead-BFGBu36H.js";import"./index-BdQXfi_H.js";import"./index-MZfphr3F.js";const s={id:"prompt-basics",icon:"fa-lightbulb",title:"프롬프트 기초",titleEn:"Prompt Fundamentals",sections:[{title:"프롬프트란 무엇인가",titleEn:"What is a Prompt",content:`AI 모델에게 원하는 결과를 얻기 위해 전달하는 입력 텍스트를 **프롬프트(Prompt)**라고 합니다.
...
> Practice grows faster with colleagues than alone. Actively use team exercises.`}]};function v(){const{language:o}=r(),t=o==="ko";return e.jsx(e.Fragment,{children:e.jsx(n,{seoTitle:"프롬프트 실습",seoTitleEn:"Prompt Lab",seoDescription:"프롬프트 작성 기법, 평가 기준, 실전 예시 및 실습 가이드",path:"/prompt-eval",dataFiles:[s,c,l,p],sidebarHeader:e.jsx(a,{}),sidebarFooter:e.jsxs(e.Fragment,{children:[e.jsxs(i,{to:"/prompt-eval/workshop",className:"guide-sidebar-cta workshop",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),e.jsxs("div",{children:[e.jsx("strong",{children:t?"프롬프트 작성 평가":"Writing Evaluation"}),e.jsx("span",{children:t?"자동 채점 & 수정 재평가":"Auto-score & re-evaluate"})]})]}),e.jsxs(i,{to:"/prompt-eval/practice",className:"guide-sidebar-cta practice",children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),e.jsxs("div",{children:[e.jsx("strong",{children:t?"종합 실습 테스트":"Full Practice Test"}),e.jsx("span",{children:t?"퀴즈 + 평가 + 작성 (250점)":"Quiz + Eval + Write (250pts)"})]})]})]}),ctaBanner:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"프롬프트 작성 평가":"Prompt Writing Evaluation"}),e.jsx("p",{children:t?"프롬프트를 직접 작성하고 SCORE 기준으로 자동 채점! 수정하며 점수 변화를 확인하세요.":"Write prompts and get auto-scored! Edit and track your score improvements."})]}),e.jsxs(i,{to:"/prompt-eval/workshop",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),t?"작성 평가 시작":"Start Workshop"]})]}),e.jsxs("div",{className:"prompt-practice-cta",style:{background:"rgba(56,161,105,0.12)",borderColor:"rgba(56,161,105,0.32)"},children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:t?"종합 실습 테스트":"Full Practice Test"}),e.jsx("p",{children:t?"선택형 퀴즈 + 프롬프트 평가 + 직접 작성까지, 250점 만점 종합 실습을 진행하세요.":"Take a 250-point practice: quiz + evaluation + writing exercises."})]}),e.jsxs(i,{to:"/prompt-eval/practice",className:"prompt-practice-cta-btn",style:{background:"#2f855a"},children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),t?"종합 실습 시작":"Start Practice"]})]})]})})})}export{v as default};
