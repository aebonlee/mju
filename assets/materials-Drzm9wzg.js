const e=[{id:"basic",nameKo:"기초과정 자료",nameEn:"Basic",icon:"fa-seedling",descKo:"생성형 AI 도구 이해와 프롬프트 작성·강의자료 제작 학습자료입니다.",descEn:"Materials on understanding AI tools, prompt writing, and lecture material creation."},{id:"intermediate",nameKo:"심화과정 자료",nameEn:"Intermediate",icon:"fa-diagram-project",descKo:"AI 기반 수업설계·평가·맞춤형 피드백 학습자료입니다.",descEn:"Materials on AI-based instructional design, assessment, and feedback."},{id:"advanced",nameKo:"전문과정 자료",nameEn:"Advanced",icon:"fa-rocket",descKo:"교과목 재설계·AI 튜터·학습성과 분석 등 고도 활용 학습자료입니다.",descEn:"Materials on course redesign, AI tutors, and learning analytics."}],t=[{id:"ai-overview",categoryId:"basic",nameKo:"생성형 AI 개요",nameEn:"Generative AI Overview",type:"guide",contentKo:`## 생성형 AI란?
...
- **Academic integrity**: Follow institutional policies on AI use`},{id:"chatgpt-guide",categoryId:"basic",nameKo:"ChatGPT 활용법",nameEn:"How to Use ChatGPT",type:"guide",contentKo:`## ChatGPT 시작하기
...
- Use GPT-4o for complex tasks, GPT-4o mini for quick queries`},{id:"claude-guide",categoryId:"basic",nameKo:"Claude 활용법",nameEn:"How to Use Claude",type:"guide",contentKo:`## Claude 소개
...
| Code Exec | Artifacts | Code Interpreter |`},{id:"gemini-guide",categoryId:"basic",nameKo:"Gemini 활용법",nameEn:"How to Use Gemini",type:"guide",contentKo:`## Google Gemini 소개
...
**Limitations**: Korean performance slightly behind GPT/Claude, limited image generation`},{id:"ai-comparison",categoryId:"basic",nameKo:"AI 서비스 비교",nameEn:"AI Service Comparison",type:"reference",contentKo:`## 주요 AI 서비스 종합 비교
...
- $40: ChatGPT Plus + Claude Pro (best of both)`},{id:"official-doc-guide",categoryId:"intermediate",nameKo:"공문서 작성 가이드",nameEn:"Official Document Guide",type:"guide",contentKo:`## AI를 활용한 공문서 작성
...
**Don't**: Submit without review, input sensitive data, cite unverified regulations`},{id:"meeting-minutes",categoryId:"intermediate",nameKo:"회의록 정리 가이드",nameEn:"Meeting Minutes Guide",type:"template",contentKo:`## AI를 활용한 회의록 작성
...
Use the structured template with: Overview, Agenda, Discussion, Decisions, Action Items, Next Meeting.`},{id:"ppt-generation",categoryId:"intermediate",nameKo:"PPT 자동 생성",nameEn:"Auto PPT Generation",type:"guide",contentKo:`## AI로 프레젠테이션 자동 제작
...
- Mention your audience for tone adjustment`},{id:"excel-automation",categoryId:"advanced",nameKo:"Excel 수식 자동화",nameEn:"Excel Formula Automation",type:"guide",contentKo:`## AI를 활용한 Excel 업무 자동화
...
AI can write VBA macros for repetitive tasks like merging multiple Excel files.`},{id:"hr-automation",categoryId:"advanced",nameKo:"인사 문서 자동화",nameEn:"HR Document Automation",type:"guide",contentKo:`## AI를 활용한 인사 문서 자동화
...
- Never input sensitive personal information`},{id:"data-analysis-basics",categoryId:"advanced",nameKo:"데이터 분석 기초",nameEn:"Data Analysis Basics",type:"guide",contentKo:`## AI를 활용한 기초 데이터 분석
...
- Remove sensitive data before input`},{id:"rcf-framework",categoryId:"basic",nameKo:"RCF 프레임워크",nameEn:"RCF Framework",type:"guide",contentKo:`## RCF 프레임워크: 효과적인 프롬프트의 3요소
...
\`\`\``},{id:"role-based-prompt",categoryId:"basic",nameKo:"역할 기반 프롬프트",nameEn:"Role-Based Prompting",type:"guide",contentKo:`## 역할 기반 프롬프트 기법
...
- Use realistic, specific roles`},{id:"chain-of-thought",categoryId:"basic",nameKo:"단계적 프롬프트 (Chain of Thought)",nameEn:"Step-by-Step Prompting",type:"guide",contentKo:`## 단계적 프롬프트 기법
